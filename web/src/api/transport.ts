...
import { FingerprintService } from '@/gen/proto/redmatrix/fingerprint/v1/fingerprint_connect';
...
export const fingerprintClient = createPromiseClient(FingerprintService, transport);
